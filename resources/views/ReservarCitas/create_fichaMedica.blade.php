        ...
        <div class="card-body">
            ...
            <div class="FormContainer">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-sm btn-outline-primary"
                                                        title="Generar ficha medica" data-toggle="modal"
                                                        data-target="#modalAgregarFichaMedica">Generar ficha medica</button>
                                                    <button class="btn btn-sm btn-outline-warning" title="Ver resumen"
                                                        data-toggle="modal" data-target="#myModal">Ver resumen</button>
                                                </td>
                                            </tr>
                                        @endforeach
                                    @endif
                ...
                <div class="modal fade" id="modalAgregarMascota" tabindex="-1" role="dialog"
                    aria-labelledby="modalAgregarMascotaLabel" aria-hidden="true">
                ...
                <button type="button" class="btn btn-sm btn-outline-success" data-toggle="modal"
                    data-target="#modalAgregarMascota">+ Agregar nueva mascota</button>

                <div class="modal fade" id="modalAgregarFichaMedica" tabindex="-1" role="dialog"
                    aria-labelledby="modalAgregarFichaMedicaLabel" aria-hidden="true">
                                ...
                                <form class="row" action="{{ url('miscitas/generar-ficha-medica') }}" method="POST">
                                    ...
                                    <div class="col-md-12 col-lg-6">
                                        <input type="hidden" name="id_mascota"
                                            value="{{ isset($mascota->id) ? $mascota->id : '' }}">

                                        <div class="form-group">
                                            <label for="peso_mascota">Peso de la mascota</label>
                                            <input type="text" class="form-control" id="peso_mascota"
                                                name="peso_mascota" required>
                                        </div>
                                                    ...
                                                    <tbody>
                                                        @foreach ($medicamentos as $medicamento)
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="number"
                                                                        name="medicamentos[{{ $medicamento->id }}]"
                                                                        min="0" max="{{ $medicamento->stock }}"
                                                                        value="0">
                                                                    <input type="hidden" name="medicamento_ids[]"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <input type="number"
                                                                        ...
                                                                        min="0" max="{{ $insumo->stock }}"
                                                                        value="0">
                                                                    <input type="hidden" name="insumo_ids[]"
                                                                        value="{{ $insumo->id }}">
                                                                </td>
                                                            </tr>
                                                        @endforeach
                                                        <input type="hidden" name="id_hora_reservada"
                                                            value="{{ $ReservarCita->id }}">
                                                    </tbody>
                                                </table>
                                            </div>
                                        </div>
