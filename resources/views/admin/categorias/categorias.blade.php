...
<title>Gestión Categorias - Veterinaria Gumiel</title>
@section('css-before')
...
@section('breadcrumbs')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" style="color:white;">Categorias</li>
    </nav>
@endsection
@section('content')
    {{-- Breadcrumb  --}}
            ...
            <div class="card shadow p-4">
                <div class="card-header border-0 p-0 mb-4">
                    <div class="d-flex justify-content-between">
                        ...
                        @can('ingresar categorias')
                            <a class="btn btn-primary ms-5" href="{{ route('admin.categorias.create') }}"
        ...
        function deleted(id_get) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    axios.post("{{ route('admin.categorias.delete') }}", {
                            id: id_get
                        })
                        .then(function(response) {

                            toastr.success('Categoria eliminado correctamente!')
