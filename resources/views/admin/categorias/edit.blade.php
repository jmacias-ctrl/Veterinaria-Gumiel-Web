...
<title>Modificar Categoria - Veterinaria Gumiel</title>
@section('css-before')
...
@endsection
@section('title')
    Modificar Categoria - Veterinaria Gumiel
@endsection
@section('js-before')
...
@section('header-title')
    Modificación de Categoria {{ $categoria->nombre }}
@endsection
@section('breadcrumbs')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page" style="color:white;">Modificar Categoria</li>
    </nav>
@endsection
@section('back-arrow')
