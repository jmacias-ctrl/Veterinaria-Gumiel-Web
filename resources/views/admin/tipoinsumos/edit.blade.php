...
@section('header-title')
    Modificacion de Tipo Insumo {{ $tipoinsumos->nombre }}
@endsection
@section('breadcrumbs')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item" aria-current="page"><a href="{{route('admin.tipoinsumos.index')}}" style="color:black;">Marcas Productos</a> </li>
