...
<title>Modificar Tipo Productos - Veterinaria Gumiel</title>
@section('css-before')
...
@endsection
@section('title')
    Modificar Tipo Producto - Veterinaria Gumiel
@endsection
@section('js-before')
...
@section('header-title')
    Modificacion de Tipo de Producto {{ $tipoproductos_ventas->nombre }}
@endsection
@section('breadcrumbs')
            ...
            <div class="card shadow p-4">
                ...
                <div class="row mt-3">
                    <div class="col">
                        ...
                        <label for="nombre" class="form-label">Nombre Tipo de Productos</label>
