<div class="btn-group d-flex justify-content-center">
    <td>
        @can('eliminar usuario')<button type="button" class="btn btn-outline-danger" onclick="deleted({{ $id }})"><span class="material-symbols-outlined">delete</span></button>@endcan
