...
<div class="email-content .center" style="background:white;">
        ...
        <main style="padding: 25px">
            ...
            <img src="{{asset('image/recordatorio.png')}}" id="cancel" alt="">
                <p style="font-size: 20px">Tienes una hora mañana <b>{{$ReservarCita->scheduled_date}}</b> a las <b>{{$ReservarCita->sheduled_time}}</b> 
                con el funcionario <b>{{$ReservarCita->funcionario->name}}</b> para <b>{{$ReservarCita->tiposervicio->nombre}}</b>.
