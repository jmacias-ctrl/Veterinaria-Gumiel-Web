...
<body style="background:#2E7646; display:flex; align-content: center;">
    <div class="email-content .center" style="background:white;">
        ...
        <main style="padding: 25px">
            ...
            <pre style="font-size: 20px">Estimado/a <b>{{$cliente}}</b>,

                Gracias por confiar en <b>{{ "Veterinaria Gumiel" }}</b>. Adjunto a este correo encontrarás el comprobante de pago por la compra que realizaste en nuestra sucursal.
