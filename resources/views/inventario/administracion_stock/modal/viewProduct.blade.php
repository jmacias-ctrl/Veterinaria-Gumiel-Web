                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-6">
                        ...
                        <div class="d-flex" id="descripcionDiv">
                            ...
                            <p id="descripcion">Lorem ipsum dolor sit amet consectetur adipisicing elit. Laborum eius recusandae eveniet
                    ...
                    <div class="col">
                        <img src="/image/productos/colonia-amarilla.png" class="img-thumbnail" alt="..."
                            id="imagen_item">
                        <p class="barcodeId fs-1 text-center user-select-none" id="id_barcode">ullamcorper</p>
                    </div>
                </div>
