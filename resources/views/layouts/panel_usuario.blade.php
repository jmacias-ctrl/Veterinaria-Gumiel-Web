        ...
        <div class="container-fluid">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link nav-link-icon" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span class="badge badge-danger">
                            @if ($userNotification < 99) {{ $userNotification }} @else 99+ @endif </span>
                    </a>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-arrow dropdown-menu-right">
                        ...
                        <a href="{{ route('logout') }}" onclick="event.preventDefault();
                            document.getElementById('logout-form').submit();" id="logout" class="dropdown-item">
            ...
            <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item">
                        @endif
                        <a class="nav-link collapse-links @if (Route::current()->getName() == 'admin') active @endif" data-toggle="collapse" href="#dashboardCollapse" role="button" aria-expanded="false" aria-controls="dashboardCollapse">
                        ...
                        <div class="collapse" id="dashboardCollapse">
                            <div class="card card-body" id="dropdown">
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link ms-3" href="{{ route('trazabilidad-ventas-y-servicios') }}" id="link-dropdown">Trazabilidad Ventas y Servicios</a>
                                    </li>
                                </ul>

                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link ms-3" href="{{ route('dashboard-citas') }}" id="link-dropdown">Dashboard Citas</a>
                                    </li>
                                </ul>
                    ...
                    <li class="nav-item">
                        @endif
                        <a class="nav-link collapse-links" data-toggle="collapse" href="#usuarioCollapse" role="button" aria-expanded="false" aria-controls="usuarioCollapse">
                        ...
                        <div class="collapse" id="usuarioCollapse">
                            <div class="card card-body" id="dropdown">
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link ms-3 @if (request()->routeIs('admin.usuarios.*')) active @endif" href="{{ route('admin.usuarios.index') }}" id="link-dropdown">Usuarios</a>
                                    </li>
                                </ul>
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link ms-3 @if (request()->routeIs('admin.horario.*')) active @endif" href="{{ url('funcionarios') }}" id="link-dropdown">Funcionario</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    @can('ver proveedores')
                    <li class="nav-item">
                        <a class="nav-link @if (request()->routeIs('proveedores.*')) active @endif" href="{{ route('proveedores.index') }}">
                    ...
                    @can('ver productos')
                    <li class="nav-item">
                        <a class="nav-link collapse-links" data-toggle="collapse" href="#productosCollapse" role="button" aria-expanded="false" aria-controls="productosCollapse">
                        ...
                        <div class="collapse" id="productosCollapse">
                            <div class="card card-body" id="dropdown">
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link ms-3 @if (request()->routeIs('productos.*')) active @endif" href="{{ route('productos.index') }}" id="link-dropdown">Productos</a>
                                    </li>
                                </ul>

                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link ms-3 @if (request()->routeIs('admin.insumos_medicos.*')) active @endif" href="{{ route('admin.insumos_medicos.index') }}" id="link-dropdown">Insumos Médicos</a>
                                    </li>
                                </ul>
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link ms-3 @if (request()->routeIs('admin.medicamentos_vacunas.*')) active @endif" href="{{ route('admin.medicamentos_vacunas.index') }}" id="link-dropdown">Medicamentos</a>
                                    </li>
                                </ul>
                            </div>
                        </div>
                    ...
                    <li class="nav-item">
                        <a class="nav-link collapse-links" data-toggle="collapse" href="#mantenedoresCollapse" role="button" aria-expanded="false" aria-controls="mantenedoresCollapse">
                        ...
                        <div class="collapse" id="mantenedoresCollapse">
                            <div class="card card-body" id="dropdown">
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link ms-3 @if (request()->routeIs('admin.marcaproductos.*')) active @endif" href="{{ route('admin.marcaproductos.index') }}" id="link-dropdown">Marcas Productos</a>
                                    </li>
                                </ul>
                                @endcan
                                @can('ver productos')
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link ms-3 @if (request()->routeIs('admin.tipoproductos_ventas.*')) active @endif" href="{{ route('admin.tipoproductos_ventas.index') }}" id="link-dropdown">Tipo Productos</a>
                                    </li>
                                </ul>
                                @endcan
                                @can('ver servicios')
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link ms-3 @if (request()->routeIs('admin.tiposervicios.*')) active @endif" href="{{ route('admin.tiposervicios.index') }}" id="link-dropdown">Tipos
                                            Servicios</a>
                                    </li>
                                </ul>
                                @endcan
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link ms-3 @if (request()->routeIs('admin.marcaInsumos.*')) active @endif" href="{{ route('admin.marcaInsumos.index') }}" id="link-dropdown">Marcas
                                            Insumos Médicos</a>
                                    </li>
                                </ul>
                                @endcan
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link ms-3 @if (request()->routeIs('admin.tipoinsumos.*')) active @endif" href="{{ route('admin.tipoinsumos.index') }}" id="link-dropdown">Tipos
                                            Insumos Médicos</a>
                                    </li>
                                </ul>
                                @endcan
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link ms-3 @if (request()->routeIs('admin.tipomedicamentos_vacunas.*')) active @endif" href="{{ route('admin.tipomedicamentos_vacunas.index') }}" id="link-dropdown">Tipos
                                            Medicamentos</a>
                                    </li>
                                </ul>
                                @endcan
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link ms-3 @if (request()->routeIs('admin.marcamedicamentos_vacunas.*')) active @endif" href="{{ route('admin.marcamedicamentos_vacunas.index') }}" id="link-dropdown">Marca
                                            Medicamentos</a>
                                    </li>
                                </ul>
                                @endcan
                                ...
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link ms-3 @if (request()->routeIs('admin.especies.*')) active @endif" href="{{ route('admin.especies.index') }}" id="link-dropdown">Especies</a>
                                    </li>
                                </ul>
                                @endcan
                            </div>
                    ...
                    @can('acceso punto de venta')
                    <li class="nav-item active">
                        <a class="nav-link @if (request()->routeIs('control-servicios.*')) active @endif" href="{{ route('control_servicios.index') }}">
                    ...
                    @can('acceso ventas')
                    <li class="nav-item active">
                        <a class="nav-link @if (request()->routeIs('ventas.*')) active @endif" href="{{ route('ventas.index') }}">
                    ...
                    <li class="nav-item active">
                        <a class="nav-link @if (request()->routeIs('administracion_inventario.*')) active @endif" href="{{ route('administracion_inventario.index') }}">
                    ...
                    <li class="nav-item">
                        <a class="nav-link collapse-links" data-toggle="collapse" href="#configWebCollapse" role="button" aria-expanded="false" aria-controls="configWebCollapse">
                        ...
                        <div class="collapse" id="configWebCollapse">
                            <div class="card card-body" id="dropdown">
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link ms-3 @if (request()->routeIs('landing.ubication.*')) active @endif" href="{{ route('landing.ubication.edit') }}" id="link-dropdown">Información General</a>
                                    </li>
                                </ul>
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link ms-3 @if (request()->routeIs('landing.nosotros.*')) active @endif" href="{{ route('landing.nosotros.edit') }}" id="link-dropdown">Seccion
                                            Nosotros</a>
                                    </li>
                                </ul>
                                <ul class="navbar-nav">
                                    <li class="nav-item">
                                        <a class="nav-link ms-3 @if (request()->routeIs('landing.website.*')) active @endif" href="{{ route('landing.website.edit') }}" id="link-dropdown">Landing
                                            Page</a>
                                    </li>
                                </ul>
                            </div>
                ...
                <form class="navbar-search navbar-search-dark form-inline mr-3 d-none d-md-flex ml-lg-auto">
                    <div class="form-group mb-0 mt-3">
                        <div class="input-group input-group-alternative">
                            ...
                            <input class="form-control" placeholder="Buscar" type="text" id="myInput" aria-controls="table">

                        </div>
                    </div>
                </form>
                <li class="nav-item dropdown">
                    <a class="nav-link nav-link-icon" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="color:black;" id="desktopNotification">
