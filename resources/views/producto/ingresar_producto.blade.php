...
<h2>Gestion Productos</h2>
            ...
            @foreach ($productos as $producto)
                <tr>
                    ...
                    <td class="d-flex justify-content-evenly">
                        <form method="POST" action="{{ route('productos.delete', ['id' => $producto->id]) }}">
                            @csrf
                            @method('DELETE')
                            <button type="submit" class="btn btn-sm btn-danger mx-1">Eliminar</button>
                        </form>
                        <button type="button" class="btn btn-sm btn-success btn-update mx-1"
                            data-object='@json($producto)' data-toggle="modal" data-target="#modalUpdate">
                            Actualizar
                        </button>
                    </td>
                </tr>
    ...
    <div class="modal" id="modalInsert">
        <form action="{{ route('productos.store') }}" method="post" enctype="multipart/form">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="number" class="form-control" placeholder="15" id="producto_enfocado"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <label for="nombre">nombre producto:</label>
                        <input type="text" class="form-control" placeholder="Coca Cola" id="nombre"
                            name="nombre">
                        <label for="marca">marca</label>
                        <textarea type="text" class="form-control" id="marca" name="marca"></textarea>
                        <label for="precio">descripccion producto:</label>
                        <input type="number" class="form-control" placeholder="15" id="descripcion"
                            name="descripcion">
                        <label for="descripccion">tipo:</label>
                        <input type="text" class="form-control" placeholder="" id="tipo" name="tipo" />
                        <label for="cantidad">Stock:</label>
