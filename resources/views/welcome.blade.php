        ...
        <div class="bg-white">
            <section class="d-flex justify-content-center align-items-center p-4">
                <div class="container bg-darkgreen rounded-50 w-50 p-4">
                    ...
                    <img src="{{ asset('images/peluqueria.png') }}"
                        style="width:95px; position: relative; opacity: 0.5;">
                </div>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6 mb-4 p-4">
                        <div class="p-4 rounded bg-white">
                            <div class="text-center">
                                <img src="{{ asset('images/peluqueria.png') }}" style="width:50%;" alt="Imagen servicio 1"
                    ...
                    <div class="col-md-6 mb-4 p-4">
                        <div class="p-4 rounded bg-white">
                            <div class="text-center">
                                <img src="{{ asset('images/veterinaria.png') }}" style="width:50%;" alt="Imagen servicio 2"
                                    class="img-fluid rounded-circle mb-3" />
                            </div>
                ...
                <div class="row">
                    <div class="col-md-6 mx-auto">
                        <form action="#" method="POST"
                            style="background-color: #6A6767; color: white; border-radius: 10px; padding: 20px;">
